...
Based on the complexity plot threshold, 3 threes are recommended.
...
The figure above indicates that the top three most important variables of this model are annual potential evapotranspiration (ER_annaulPET), altitude (WC_alt), and annual precipitation (WC_bio12).
